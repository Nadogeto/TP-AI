...
public class Drone : MonoBehaviour
{
    ...
    //switch le current state du drone (passe de wander -> chase -> kill)/ décide de la trajectoire selon si le path est bloqué ou non
    private void Update()
    {
    ...
    //détecte les murs ou obstacles sur le path du drone
    ...
    //si destination atteinte, fournit une nouvelle 
